...
using ClassLibraryGraphGameJSON;
...
namespace ClassLibraryGraphGame
{
    ...
    public class GameGraph
    {
        ...
        public void LoadLevel(int numLevel)
        {
            ...
            byte[] byteJson = (byte[])Properties.Resources.ResourceManager.GetObject(string.Format("level{0}", numLevel));
        ...
        private void GenerateLevelPoints()
        {
            ...
            while (num <= countLevel)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    levelPoint.XLength = ConstantBase.X_LENGTH_LEVEL_POINT;
                    levelPoint.YLength = ConstantBase.Y_LENGTH_LEVEL_POINT;
                    levelPoint.XCoordinate = i * (ConstantBase.X_LENGTH_LEVEL_POINT +
                        ConstantBase.X_INTERVAL_BEETWEEN_LEVEL_POINT);
                    levelPoint.YCoordinate = j * (ConstantBase.Y_LENGTH_LEVEL_POINT +
                        ConstantBase.Y_INTERVAL_BEETWEEN_LEVEL_POINT);
                    levelPoint.BitmapMain = ConstantBase.LEVEL_POINT_IMAGE;
        ...
        private void GenerateEndLevelButtons()
        {
            ...
            _nextLevelButton.BitmapMain = ConstantBase.LEVEL_POINT_IMAGE;
            ...
            _repeatCurrentLevelButton.BitmapMain = ConstantBase.LEVEL_POINT_IMAGE;
            ...
            _goChoiceLevelButton.BitmapMain = ConstantBase.LEVEL_POINT_IMAGE;
        }
